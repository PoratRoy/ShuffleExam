...
\`\`\``,
        answers: [
          'שורות 5 ו-6 משתמשות באותה רשימה ולכן הפלט מצטבר.',
          ...
          'הקוד מחזיר תמיד רק את האיבר האחרון שהוכנס.',
        ],
        correctAnswer: 0,
      },
    ],
...
\`\`\``,
        answers: [
          'יודפס 19 כי הלולאה מדלגת על כפולות של 3 ועוצרת כאשר i מגיע ל-8, וסוכמת את השאר.',
...
\`\`\``,
        answers: [
          "שורה 2 תדפיס 'World', שורה 3 תדפיס 'World', שורה 4 תדפיס 'Hlo ol!'.",
...
\`\`\``,
        answers: [
          'שורה 3 תדפיס {2, 3, 5} ושורה 4 תדפיס 3 כי set comprehension שומר ערכים ייחודיים בלבד.',
